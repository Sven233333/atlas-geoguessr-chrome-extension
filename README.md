...
![A GeoGuessr round open in Chrome with the ATLAS side panel beside it, naming the country and the coordinates](images/platforms-chrome-live.webp)
...
![The ATLAS panel showing the location card, the coordinates and the guess button](images/platforms-extension.webp)
